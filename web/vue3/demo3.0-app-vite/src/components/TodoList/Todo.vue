<template>
  <section class="todoapp">
    ...
    <section class="main" v-show="todosRef.length">
      <input id="toggle-all" class="toggle-all" type="checkbox" v-model="allDoneDef" />
    ...
    <footer class="footer" v-show="todosRef.length">
      ...
      <ul class="filters">
        ...
        <li><a href="#/active" :class="{ selected: visibilityRef === 'all' }">Active</a></li>
        <li><a href="#/completed" :class="{ selected: visibilityRef === 'all' }">Completed</a></li>
      </ul>
      <button class="clear-completed" v-show="completedRef > 0" @click="removeCompleted">Clear completed</button>
    </footer>
  </section>
</template>
...
.footer {
  box-shadow: rgba(0, 0, 0, 0.2) 0px 1px 1px, rgb(246, 246, 246) 0px 8px 0px -3px, rgba(0, 0, 0, 0.2) 0px 9px 1px -3px,
